...
function showTask($taskId,$taskName,$date,$priority,$lebelName,$colorCode)
{
...
?>
  <div class="card m-auto mb-3 shadow" style="background-color: <?php echo $colorCode ?>; border: 1px solid transparent">
    <div class="card-body">
      <div class="row">
        <div class="col-md-1">
          <input type="checkbox" class="mx-3 my-2" name="checked_id[]" value=" <?php echo $taskId; ?>" />
        </div>
        <div class="col-md-8">
          <div class="row">
            <div class="col-md-12">
        ...
        <div class="col-md-3">
          <a class="btn btn-md btn-warning" style="float: right;" href="updateTask.php?id=<?php echo ($taskId); ?>">Update</a>
          <a class="btn btn-md btn-danger" style="float: right;" href="deleteTask.php?id=<?php echo ($taskId); ?>">Delete</a>
        </div>
      </div>
    </div>
  </div>
